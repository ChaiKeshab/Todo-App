    ...
    return (
        <>
            ...
            md:p-5 md:w-[500px]'>
                ...
                <h1 className='w-full border-b border-gray-200 p-3 text-base text-center font-semibold text-gray-600 md:text-2xl'>Add Todo</h1>
                ...
                <div className='flex justify-around w-full gap-2 py-3'>
                    <Button
                        onClick={() => dispatch(isModalClose())}
                        className="group flex justify-center items-center gap-2 text-sm text-white bg-gray-500 px-4 py-0.5 border-gray-500 border rounded-xl
